...
class ProfileBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        menu1 = QMenu(self)
        menu1.addAction(QAction(tr("context.install_mod"), self, triggered=_todo("install_mod")))
        menu1.addAction(QAction(tr("context.create_empty_mod"), self, triggered=_todo("create_empty_mod")))
        menu1.addAction(QAction(tr("context.create_separator"), self, triggered=_todo("create_separator")))
        menu1.addSeparator()
        ...
        menu1.addSeparator()
        menu1.addAction(QAction(tr("context.enable_all"), self, triggered=_todo("enable_all")))
        menu1.addAction(QAction(tr("context.disable_all"), self, triggered=_todo("disable_all")))
        menu1.addSeparator()

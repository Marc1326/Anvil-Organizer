...
class CreateInstanceWizard(QDialog):
    ...
    def _create_paths_page(self) -> None:
        ...
        self._mods_browse_btn.setIcon(QIcon("anvil/assets/icons/ui/ordner.png"))
        ...
        self._downloads_browse_btn.setIcon(QIcon("anvil/assets/icons/ui/ordner.png"))
        ...
        self._overwrite_browse_btn.setIcon(QIcon("anvil/assets/icons/ui/ordner.png"))

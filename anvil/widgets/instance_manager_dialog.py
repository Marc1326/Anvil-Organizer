...
class InstanceManagerDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self._location_btn.setStyleSheet("color: #E8B84B; font-size: 20px; border: none;")
        ...
        self._base_btn.setStyleSheet("color: #E8B84B; font-size: 20px; border: none;")
        ...
        self._game_path_btn.setText("📂")
        self._game_path_btn.setObjectName("exploreBtn")
        self._game_path_btn.setStyleSheet("color: #E8B84B; font-size: 20px; border: none;")

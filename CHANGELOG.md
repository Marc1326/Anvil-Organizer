...
- **Beim Packen in BA2-Archive landeten Verwaltungsdateien mit im Archiv** — `fomod_choices.json`, der `fomod`-Ordner des Installers, Vorschaubilder und Readmes. Im Spiel haben sie dort nichts zu suchen und blähten die Archive unnötig auf. Packen, Ausrollen und Konflikterkennung richten sich jetzt nach einer gemeinsamen Regel.
